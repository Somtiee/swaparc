          ...
          >
            ...
            >
              ...
              {!CIRCLE_APP_ID && (
                ...
                >
                  Missing Circle App ID - go to Circle Console, then Wallets, User Controlled, Configurator, App ID and set VITE_CIRCLE_APP_ID in your .env.
                </div>
              )}
              ...
              {activeTab === "swap" && (
                <>
                  ...
                  {swapSummary.isHighImpact && !swapSummary.isExtremeImpact && (
                    <p className="quote" style={{ marginTop: 10, color: "#f59e0b" }}>
                      ! This trade has high price impact due to low liquidity.
                    </p>
                  )}

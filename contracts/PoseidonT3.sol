...
// Poseidon t=3 (2 inputs), BN254 — matches circomlib `Poseidon(2)` / circomlibjs `poseidon([a,b])`.
// Source: https://github.com/chancehudson/poseidon-solidity (MIT)
...
library PoseidonT3 {
 ...
 // Inspired by: https://github.com/iden3/circomlibjs/blob/v0.0.8/src/poseidon_slow.js
    /// @dev External entry for linked library deployment — keeps ZKPrivacyPool runtime small on size-limited chains.
 ...
 // ABI: selector + two uint256 words (static [2] in calldata)
 let state1 := add(mod(calldataload(4), F), 0x00f1445235f2148c5986587169fc1bcd887b08d4d00868df5696fff40956e864)
 let state2 := add(mod(calldataload(36), F), 0x08dff3487e8ac99e1f29a058d0fa80b930c728730b7ab36ce879f3890ecf73f5)

 ...
 *  Shared by autopay AND the claim/deposit relay — the same relayer EOA signs
 *  both, so both need the nonce-fresh send. */
export async function sendRelayerContractTx(relayerWallet, sendFn, baseOverrides = {}) {
